...
Comparison of the DMSO spectra obtained with the system and the mprofessional probe after Raman shift [software](https://github.com/ACDBio/raman-open-forge-imai) calibration. Note: the DIY system spectra are normalized by top peak. No preprocessing was used.
