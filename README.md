...
Comparison of the DMSO spectra obtained with the system and the mprofessional probe after Raman shift [software](https://github.com/ACDBio/raman-open-forge-imai) calibration. Note: the DIY system spectra are normalized by top peak. No preprocessing was used. Smoothing was set to 1/10 in both cases.
...
The focusing distance of the SZMCTV 1/2 Microscope Camera Adapter is adjustable and should be moved to the extreme position for optimal performance.
...
5. [15 degree IR LED PMMA lens](https://aliexpress.ru/item/32820431045.html?spm=a2g2w.orderdetail.0.0.75834aa6qalnJD&sku_id=64707315106&_ga=2.189769388.606840197.1770619478-1631170546.1742897773) for light collection (is inserted in the cuvette holder)
